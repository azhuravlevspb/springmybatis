 ...
 * <li><b>{@link Ext.grid.ColumnModel Column com.springmybatis.model}</b> : Column makeup
 * <div class="sub-desc"></div></li>
 * <li><b>{@link Ext.grid.GridView View}</b> : Encapsulates the user interface
 * <div class="sub-desc"></div></li>
 * <li><b>{@link Ext.grid.AbstractSelectionModel selection com.springmybatis.model}</b> : Selection behavior
 * <div class="sub-desc"></div></li>
 * </ul></div>
 * <p>Example usage:</p>
 * <pre><code>
 ...
 * <li>To access the data in a Grid, it is necessary to use the data com.springmybatis.model encapsulated
...
Ext.grid.GridPanel = Ext.extend(Ext.Panel, {
     ...
     * the selection com.springmybatis.model for the grid (defaults to {@link Ext.grid.RowSelectionModel} if not specified).
     */
    /**
...
function(grid, rowIndex, columnIndex, e) {
    ...
    var data = record.get(fieldName);
            ...
            /**
             * @event reconfigure
             * Fires when the grid is reconfigured with a new store and/or column com.springmybatis.model.
             * @param {Grid} this
             * @param {Ext.data.Store} store The new store
             * @param {Ext.grid.ColumnModel} colModel The new column com.springmybatis.model
             */
            'reconfigure',
            /**
             * @event viewready
    ...
    /**
     * Returns the grid's selection com.springmybatis.model configured by the <code>{@link #selModel}</code>
     * configuration option. If no selection com.springmybatis.model was configured, this will create
     ...
     * @return {Ext.grid.ColumnModel} The column com.springmybatis.model
     */
...
Ext.grid.PivotGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        ...
        //TODO: dummy col com.springmybatis.model that is never used - GridView is too tightly integrated with ColumnModel
 ...
 * com.springmybatis.model of a Grid is held in an {@link Ext.data.Store}.</p>
 * @constructor
 * @param {Object} config
 */
...
viewConfig: {
     ...
     * @param {Number} colCount The total number of columns in the column com.springmybatis.model
...
Ext.grid.ColumnModel = Ext.extend(Ext.util.Observable, {
    ...
    /**
     * <p>Reconfigures this column com.springmybatis.model according to the passed Array of column definition objects.
...
myGrid.getColumnModel().setHidden(0, true); // hide column 0 (0 = the first column).
    ...
    /**
     * Destroys this column com.springmybatis.model by purging any event listeners. Destroys and dereferences all Columns.
     */
    destroy : function() {
        var length = this.config.length,
            i = 0;
...
Ext.grid.RowSelectionModel = Ext.extend(Ext.grid.AbstractSelectionModel,  {
    ...
    /**
     * Clears all selections if the selection com.springmybatis.model
    ...
    /**
     * Selects all rows if the selection com.springmybatis.model
     * {@link Ext.grid.AbstractSelectionModel#isLocked is not locked}. 
     */
    selectAll : function(){
        if(this.isLocked()){
    ...
    /**
     * Selects a range of rows if the selection com.springmybatis.model
     * {@link Ext.grid.AbstractSelectionModel#isLocked is not locked}.
    ...
    /**
     * Deselects a range of rows if the selection com.springmybatis.model
     * {@link Ext.grid.AbstractSelectionModel#isLocked is not locked}.  
    ...
    /**
     * Selects a row.  Before selecting a row, checks if the selection com.springmybatis.model
    ...
    /**
     * Deselects a row.  Before deselecting a row, checks if the selection com.springmybatis.model
 ...
 * A custom selection com.springmybatis.model that renders a column of checkboxes that can be toggled to select or deselect rows.
 * @constructor
 * @param {Object} config The configuration options
 */
