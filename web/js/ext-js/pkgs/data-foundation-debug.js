     ...
     * object takes the following form:</p><pre><code>
{
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        autoExpandColumn: 'company', // match the id specified in the column com.springmybatis.model
        height:350,
        width:600,
        title:'Array Grid',
        tbar: [{
...
api: {
     ...
     * <pre><code>
api: {
    load :    '/com.springmybatis.controller/load',
    create :  '/com.springmybatis.controller/new',  // Server MUST return idProperty of new record
    save :    '/com.springmybatis.controller/update',
    destroy : '/com.springmybatis.controller/destroy_action'
}
...
DESTROY  /users/23  delete
     ...
     * someSite.com/com.springmybatis.controller/action/id
     * </code></pre>
     * Where the segments in the url are typically:<div class="mdetail-params"><ul>
     * <li>The first segment : represents the com.springmybatis.controller class that should be invoked.</li>
...
proxy.setApi(Ext.data.Api.actions.read, '/users/new_load_url');
     ...
     * url will be built Rails-style, as in "/com.springmybatis.controller/action/32".  restful will aply iff the supplied record is an
