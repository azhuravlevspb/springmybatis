...
(function(){
    ...
    cls.push({
        ...
        checks: [{
            ...
            fn: function(){
                if(!this.colModel){
                    A.error('No column com.springmybatis.model specified for grid', this);
                }
                if(!this.store){
            ...
            fn: function(){
                ...
                if(!this.userResized && g.autoExpandColumn){
                    ...
                    if(tw != aw){
                        ...
                        if(ci == -1){
                            A.error('The autoExpandColumn does not exist in the column com.springmybatis.model', g, g.autoExpandColumn);
                            return false;
                        }
                    }
                }
